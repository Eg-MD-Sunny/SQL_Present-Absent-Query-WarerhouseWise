Select		EmployeeAttendance.ForDate,
			...
			(case when Designation.DepartmentTypeId=1 then 'HQ'
			 ...
			 when Designation.DepartmentTypeId=15 then 'Pharmacy' else null end)[DepartmentType Name],
			 Designation.DesignationName,
			joinedon, ShiftStartTime1,ShiftStartTime2,
	...
	--		,EmployeeAttendance.IsExpected
	--		,EmployeeAttendance.AccountingEventId
	--		,EmployeeAttendance.OnPaidLeave
...
--Group By	BadgeId, FullName, joinedon
--Order By	EmployeeAttendance.ForDate